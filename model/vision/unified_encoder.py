...
class UnifiedSpatialCrossEncoderV2(nn.Module):
    """
       ...
       dim_loc: 
    """
    def __init__(self, hidden_size=768, num_attention_heads=12, num_layers=4, dim_loc=6, freeze=False):
        super().__init__()
        self.freeze = freeze
    ...
    def freeze_parameters(self):
        print("Freezing unified encoder and previous layers")
        for param in self.unified_encoder.parameters():
            param.requires_grad = False
        for param in self.loc_layers.parameters():
            param.requires_grad = False
